...
const TABS: { id: WorkTab; label: string; icon: string }[] = [
  ...
  { id: 'cloud', label: '云端', icon: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4.5 12a3.5 3.5 0 01-.5-6.96 4 4 0 017.5-1.04A3 3 0 0112 11.5H4.5z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/></svg>' },
