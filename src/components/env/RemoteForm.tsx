  ...
  return (
    <div className="env-form">
      <div className="env-field">
        <label className="env-label">远程实例</label>
      ...
      <div className="env-field">
        ...
        <p className="env-hint">需已在远程服务器安装。任务将在远端由该 CLI 执行。</p>
      </div>

      <div className="env-field">
        <label className="env-label">远程工作目录（可选）</label>
        <input
          className="env-input"
